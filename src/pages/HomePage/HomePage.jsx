    ...
    <div className={css.homeMain}>
      <div className={css.homeContainer}>
        ...
        <div className={css.waterRatioPanel}>
          <WaterRatioPanel openAddNewWaterRecordModalHandler={openAddNewWaterRecordModalHandler} />
        </div>
        <div className={css.tableWrapper}>
          <TodayWaterList openAddNewWaterRecordModalHandler={openAddNewWaterRecordModalHandler} />
          <MonthStatsTable />
        </div>
        {modalIsOpen && (
            <AddWaterForm
